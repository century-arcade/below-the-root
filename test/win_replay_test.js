...
assert.equal(completion(replay.state), 82);
...
assert.match(panelLines(continued.state).join(''), /82% COMPLETE/);
...
assert.match(report, /82% complete; Raamo saved/);
console.log('win_replay_test: Pomma starts a fresh quest and saves Raamo on day 3; 82% complete');
