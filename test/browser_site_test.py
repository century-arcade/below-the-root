...
with sync_playwright() as p:
    ...
    for width in [1200, 390]:
        ...
        # About keys must neither open game overlays nor send joystick input.
        ...
        assert after['inputs'] == before['inputs'], 'About must not steer the quest'
        ...
        page.locator('#site-header a[href="#play"]').click()
        expect(page.locator('#screen')).to_be_focused()
        page.goto(BASE + '/')
